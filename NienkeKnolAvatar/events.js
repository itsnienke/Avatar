...
var zukoBar = document.getElementById("zukoBar");
var kataraBar = document.getElementById("kataraBar");
var waterbendingButton = document.getElementById("waterbendingButton");
var bloodbendingButton = document.getElementById("bloodbendingButton");
var healButton = document.getElementById("healButton");
var messageLost = document.getElementById("messageLost");
var messageWon = document.getElementById("messageWon");
...
function bloodbending() {
    randomWidth = Math.random() < 0.5 ? 9 : 2; // WILLEKEURIG GEKOZEN OF HET 9 OF 2 DMG DOET
    width -= randomWidth;
    if (width < 0) {
        width = 0
        messageWon.textContent = 'YOU WIN';
...
function zukoReactionBlood() {
    randomWidth = Math.random() < 0.5 ? 9 : 2;  
    if (width < 0) {
        width = 0
        messageLost.textContent = 'YOU LOST';
        zukoAudios.play()
...
function heal() {
  ...
  healButton.style.backgroundColor = "#808080";
}
